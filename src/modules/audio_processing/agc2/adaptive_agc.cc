...
void AdaptiveAgc::Process(AudioFrameView<float> float_frame,
  ...
  //std::cout << "In AdaptiveAgc!" << std::endl;

  auto signal_with_levels = SignalWithLevels(float_frame);
  signal_with_levels.vad_result = vad_.AnalyzeFrame(float_frame);

  //std::cout << "agc2_vad_probability: " << signal_with_levels.vad_result.speech_probability
    //        << ", agc2_vad_rms_dbfs: " << signal_with_levels.vad_result.speech_rms_dbfs
      //      << ", agc2_vad_peak_dbfs: " << signal_with_levels.vad_result.speech_peak_dbfs << std::endl;
